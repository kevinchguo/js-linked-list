...
if (!window) {
  ...
  var basicsFile = fs.readFileSync(process.cwd() + "/linkedList.js", {
    encoding: "UTF-8"
  });
...
describe("Linked List Generator", function() {
  ...
  describe("`get` method", function() {
    ...
    beforeEach(function() {
      ...
      var bookArr = ["Ready Player One", "1982", "Neuromancer", "Snow Crash"];
  ...
  describe("`insert` method", function() {
    ...
    beforeEach(function() {
      ...
      var urlArr = ["news.ycombinator.com", "icann.org"];

      var bookArr = ["Neuromancer", "Snow Crash"];
